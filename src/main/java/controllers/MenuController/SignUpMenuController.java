...
public class SignUpMenuController extends UserInfoController {
    ...
    public static AlertMaker signUp(String questionNum, String answer, String confirmAnswer) {
        ...
        GameServer.getLoggedInUser().setSecurityQuestionNumber(questionNumber);
        GameServer.getLoggedInUser().setSecurityAnswer(answer);
        GameServer.addNewUser(GameServer.getLoggedInUser());
        DataSaver.saveUsers();
    ...
    public static void createUser(String username, String password, String nickname, String email) {
        GameServer.setLoggedInUser(new User(username, password, email, nickname));
    }

...
public enum LeaderInfo {
    THE_SIEGEMASTER("The Siegemaster", "/Assets/Cards/Plane/realms_foltest_silver.jpg", "/Assets/Cards/Detailed/realms_foltest_silver.jpg", Factions.NORTHERN_REALMS, "Pick an Impenetrable Fog card from your\ndeck and play it instantly."),
    THE_STEEL_FORGED("The Steel-Forged", "/Assets/Cards/Plane/realms_foltest_gold.jpg", "/Assets/Cards/Detailed/realms_foltest_gold.jpg", Factions.NORTHERN_REALMS, "Clear any weather effects (resulting from\nBiting Frost,Torrential Rain or Impenetrable\nFog cards) in play.)"),
    KING_OF_TEMERIA("King of Temeria", "/Assets/Cards/Plane/realms_foltest_copper.jpg", "/Assets/Cards/Detailed/realms_foltest_copper.jpg", Factions.NORTHERN_REALMS, "Doubles the strength of all your Siege\nunits (unless a Commander's Horn is also\npresent on the row)."),
    LORD_COMMANDER_OF_THE_NORTH("Lord Commander of the North", "/Assets/Cards/Plane/realms_foltest_bronze.jpg", "/Assets/Cards/Detailed/realms_foltest_bronze.jpg", Factions.NORTHERN_REALMS, "Destroy your enemy's strongest Siege unit(s)\nif the combined strength of all his or her\nSiege units is 10 or more."),
    SON_OF_MEDELL("Son of Medell", "/Assets/Cards/Plane/realms_foltest_son_of_medell.jpg", "/Assets/Cards/Detailed/realms_foltest_son_of_medell.jpg", Factions.NORTHERN_REALMS, "Destroy your enemy's strongest Ranged Combat\nunit(s) if the combined strength of all his\nor her or Ranged Combat units is 10 or more"),
    THE_WHITE_FLAME("The White Flame", "/Assets/Cards/Plane/nilfgaard_emhyr_silver.jpg", "/Assets/Cards/Detailed/nilfgaard_emhyr_silver.jpg", Factions.NILFGAARD, "Pick a Torrential Rain card from your deck\nand play it instantly."),
    HIS_IMPERIAL_MAJESTY("His Imperial Majesty", "/Assets/Cards/Plane/nilfgaard_emhyr_copper.jpg", "/Assets/Cards/Detailed/nilfgaard_emhyr_copper.jpg", Factions.NILFGAARD, "Look at 3 random cards from your opponent's\nhand."),
    ...
    INVADER_OF_THE_NORTH("Invader of the North", "/Assets/Cards/Plane/nilfgaard_emhyr_invader_of_the_north.jpg", "/Assets/Cards/Detailed/nilfgaard_emhyr_invader_of_the_north.jpg", Factions.NILFGAARD, "Abilities that restore a unit to the battlefield\n restore a randomly-chosen unit.\nAffects both players"),
    BRINGER_OF_DEATH("Bringer of Death", "/Assets/Cards/Plane/monsters_eredin_silver.jpg", "/Assets/Cards/Detailed/monsters_eredin_silver.jpg", Factions.MONSTERS, "Double the strength of all your Close Combat\nunits (unless a Commander's horn is also\npresent on that row)."),
    KING_OF_THE_WILD_HUNT("King of the wild Hunt", "/Assets/Cards/Plane/monsters_eredin_bronze.jpg", "/Assets/Cards/Detailed/monsters_eredin_bronze.jpg", Factions.MONSTERS, "Restore a card from your discard pile to\nyour hand."),
    DESTROYER_OF_WORLDS("Destroyer of Worlds", "/Assets/Cards/Plane/monsters_eredin_gold.jpg", "/Assets/Cards/Detailed/monsters_eredin_gold.jpg", Factions.MONSTERS, "Discard 2 card and draw 1 card of your\nchoice from your deck."),
